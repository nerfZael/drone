...
describe('desktop themes', () => {
  ...
  test('maps Catppuccin desktop surfaces into a readable visual hierarchy', () => {
    ...
    expect(tokens).toMatchObject({
      ...
      '--field-fg': '#e6e9ff',
      '--field-placeholder': '#a6adc8',
      '--border-subtle': 'rgba(49, 50, 68, .78)',
      '--assistant-message-fg': '#cdd6f4',
      '--chat-card-bg': '#242437',
      '--chat-card-border': 'rgba(88, 91, 115, .72)',
      '--chat-card-selected': '#313244',
      '--chat-list-marker': '#a6adc8',
      '--user-bubble': '#313244',
      '--user-bubble-border': 'rgba(69, 71, 90, .48)',
      '--user-bubble-fg': '#cdd6f4',
      '--chat-background': '#1e1e2e',
      '--chat-message-time': '#a6adc8',
      '--chat-user-message-time': '#bac2de',
      '--chat-composer-border': 'rgba(69, 71, 90, .56)',
      '--chat-composer-focus-border': 'rgba(203, 166, 247, .38)',
      '--chat-composer-surface': '#313244',
      '--chat-composer-fg': '#e6e9ff',
      '--chat-composer-placeholder': '#a6adc8',
      '--chat-composer-control-bg': 'rgba(69, 71, 90, .34)',
      '--chat-composer-control-border': 'transparent',
      '--chat-composer-control-fg': '#bac2de',
      '--chat-composer-model-fg': '#a6adc8',
      '--chat-composer-context-track': 'rgba(49, 50, 68, .78)',
      '--chat-composer-expanded-placeholder': '#bac2de',
      '--chat-composer-expanded-control-bg': 'rgba(69, 71, 90, .62)',
      '--chat-composer-expanded-control-border': 'rgba(127, 132, 156, .28)',
      '--chat-composer-expanded-control-fg': '#e6e9ff',
      '--chat-composer-expanded-model-fg': '#cdd6f4',
      '--chat-composer-expanded-context-track': 'rgba(127, 132, 156, .42)',
      '--chat-composer-font': 'system-ui, -apple-system, sans-serif',
      '--chat-composer-radius': '.75rem',
      '--chat-composer-control-radius': '.5rem',
      ...
      '--workspace-header-title-fg': '#f2f4ff',
      '--sidebar-bg': '#181825',
      ...
      '--sidebar-row-selected-bg': 'rgba(203, 166, 247, .12)',
      '--sidebar-meta-fg': '#a6adc8',
