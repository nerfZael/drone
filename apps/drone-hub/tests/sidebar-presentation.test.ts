...
describe('sidebar presentation', () => {
  ...
  test('uses one density contract for every sidebar renderer', () => {
    ...
    expect(compact.chatIndent).toContain('ml-[11px]');
    expect(normal.chatIndent).toContain('ml-3');
    expect(comfortable.chatIndent).toContain('ml-[15px]');
    expect(compact.nestedDroneRail).toContain('ml-[11px]');
    expect(normal.nestedDroneRail).toContain('ml-3');
    expect(comfortable.nestedDroneRail).toContain('ml-[15px]');
    expect(compact.nestedDroneRail).toContain('pl-0');
    expect(normal.nestedDroneIndent).toBe('');
