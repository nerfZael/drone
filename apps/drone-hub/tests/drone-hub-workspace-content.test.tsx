...
mock.module('../src/droneHub/app/KanbanBoardWorkspace', () => ({
  KanbanBoardWorkspace: mockedView('kanban'),
}));
...
function baseProps(overrides: Partial<DroneHubWorkspaceContentProps> = {}): DroneHubWorkspaceContentProps {
  return {
    ...
    kanbanBoardWorkspaceProps: null,
...
describe('DroneHubWorkspaceContent lazy workspace views', () => {
  ...
  test.each([
    ...
    ['kanban', { kanbanBoardWorkspaceProps: {} as DroneHubWorkspaceContentProps['kanbanBoardWorkspaceProps'] }],
