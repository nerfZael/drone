...
export function DotenvImportSection({
  ...
  textareaClassName = 'min-h-[110px] rounded border border-[var(--border-subtle)] bg-[var(--panel-raised)] px-3 py-2 font-mono text-11 text-[var(--fg)] focus:outline-none',
  ...
  return (
    <div className={containerClassName}>
      <div>
        ...
        <div className="text-11 text-[var(--muted-dim)]">{description}</div>
      </div>
      <textarea
        value={importText}
