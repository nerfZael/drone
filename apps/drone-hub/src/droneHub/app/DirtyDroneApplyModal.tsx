    ...
    >
      <div className="w-full max-w-[640px] overflow-hidden rounded-[18px] border border-[var(--border-subtle)] bg-[var(--panel-overlay)] shadow-[0_28px_90px_var(--shadow-color)]">
        <div className="border-b border-[var(--border-subtle)] px-6 py-5">
          ...
          <div className="mt-2 text-13 leading-6 text-[var(--muted)]">
        ...
        <div className="space-y-3 px-6 py-5">
          ...
          >
            <div className="text-13 font-[var(--weight-semibold)] text-[var(--fg)]">Apply committed changes only</div>
            <div className="mt-1 text-12 leading-5 text-[var(--muted)]">
          ...
          <button
            ...
            className={`w-full rounded-[16px] border px-4 py-4 text-left transition-all ${actionCardClass(busy)}`}
          >
            <div className="text-13 font-[var(--weight-semibold)] text-[var(--fg)]">Commit all changes and apply</div>
            <div className="mt-1 text-12 leading-5 text-[var(--muted)]">
