  ...
  return (
    <div className="hidden xl:flex items-center gap-1.5 pl-1 border-l border-[var(--border-subtle)]">
      <button
        ...
        className={`inline-flex items-center gap-1 px-2 py-1 rounded text-10 font-[var(--weight-semibold)] tracking-wide uppercase border transition-all ${
          error
      ...
      {previewRows.map((pr) => (
        <button
          ...
          type="button"
          onClick={onOpenPullRequestsTab}
          className="inline-flex items-start gap-1.5 max-w-[280px] px-2 py-1 rounded text-10 border border-[var(--accent-muted)] bg-[var(--accent-subtle)] text-[var(--accent)] hover:brightness-110 transition-all"
      ...
      {firstPr ? (
        <>
          <button
            ...
            className="inline-flex items-center px-2 py-1 rounded text-9 font-[var(--weight-semibold)] tracking-wide uppercase border border-[var(--green-border)] bg-[var(--green-subtle)] text-[var(--green)] hover:brightness-110 disabled:opacity-45 disabled:cursor-not-allowed transition-all"
            style={{ fontFamily: 'var(--display)' }}
          ...
          <button
            ...
            disabled={Boolean(busyAction)}
            className="inline-flex items-center px-2 py-1 rounded text-9 font-[var(--weight-semibold)] tracking-wide uppercase border border-[var(--red-border)] bg-[var(--red-subtle)] text-[var(--red)] hover:brightness-110 disabled:opacity-45 disabled:cursor-not-allowed transition-all"
            style={{ fontFamily: 'var(--display)' }}
