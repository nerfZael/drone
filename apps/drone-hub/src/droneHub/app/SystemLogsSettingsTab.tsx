      ...
      >
        <div className="inline-flex items-center gap-2 min-w-0">
          ...
          <div>
            ...
            <div className="text-11 text-[var(--muted-dim)] mt-1">{description}</div>
          </div>
        </div>
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className={`h-8 px-3 rounded text-11 font-[var(--weight-semibold)] tracking-wide uppercase border transition-all inline-flex items-center gap-1.5 ${
