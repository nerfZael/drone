...
export function DroneErrorModal({ droneErrorModal, clearingDroneError, onClose, onClearDroneHubError }: DroneErrorModalProps) {
  return (
    ...
    >
      <div className="w-full max-w-[720px] rounded-lg border border-[var(--border-subtle)] bg-[var(--panel-alt)] shadow-[0_24px_80px_var(--shadow-color)] overflow-hidden animate-slide-up relative">
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-[var(--red)] via-[var(--red-border)] to-transparent opacity-60" />
            ...
            <div className="mb-3 p-3 rounded border border-[var(--red-border)] bg-[var(--red-subtle)]">
              ...
              {droneErrorModal.conflict.files.length > 0 && (
                <div className="mt-2">
                  ...
                  <div className="max-h-20 overflow-y-auto rounded border border-[var(--border-subtle)] bg-[var(--surface-inset)] p-2 font-mono text-[10px] text-[var(--fg-secondary)]">
        ...
        <div className="px-5 py-4 border-t border-[var(--border)] bg-[var(--surface-inset-faint)] flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="h-9 px-3 rounded text-[11px] font-semibold tracking-wide uppercase border border-[var(--border-subtle)] bg-[var(--surface-softest)] text-[var(--muted)] hover:bg-[var(--hover)] hover:text-[var(--fg-secondary)] transition-all inline-flex items-center gap-1.5"
              style={{ fontFamily: 'var(--display)' }}
            >
            ...
            <button
              type="button"
              onClick={onClose}
              className="h-9 px-3 rounded text-[11px] font-semibold tracking-wide uppercase border border-[var(--border-subtle)] bg-[var(--surface-softest)] text-[var(--muted)] hover:bg-[var(--hover)] hover:text-[var(--fg-secondary)] transition-all"
              style={{ fontFamily: 'var(--display)' }}
            >
              Close
            </button>
