...
export const SHORTCUT_DEFINITIONS: ShortcutDefinition[] = [
  ...
  {
    id: 'snipCompanion',
    label: 'Snip image for Companion',
    description: 'Select a region or the full cursor screen and attach it to your next Companion instruction. Enable Global to use outside Drone Hub (desktop app required).',
  },
  {
    id: 'captureCompanionScreen',
    label: 'Capture screen for Companion',
    description: 'Immediately attach the screen under the cursor. Enable Global to use outside Drone Hub (desktop app required).',
  },
  {
    id: 'toggleCompanion',
...
export function cloneDefaultShortcutBindings(): ShortcutBindingMap {
  return {
    ...
    snipCompanion: cloneShortcutBinding(DEFAULT_SHORTCUT_BINDINGS.snipCompanion),
    captureCompanionScreen: cloneShortcutBinding(DEFAULT_SHORTCUT_BINDINGS.captureCompanionScreen),
