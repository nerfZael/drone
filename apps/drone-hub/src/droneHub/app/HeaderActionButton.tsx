  ...
  function HeaderActionButton(
    ...
    return (
      <button
        ...
        className={cn(
          'inline-flex items-center gap-1.5 rounded border px-2.5 py-1.5 dh-type-header-action transition-all focus-visible:border-[var(--accent-muted)] focus-visible:outline-none',
          disabled
