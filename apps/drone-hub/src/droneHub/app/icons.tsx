...
export function IconCirclePause({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="16"
...
export function IconGitCommitHorizontal({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="16"
...
export function IconFileDiff({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="16"
