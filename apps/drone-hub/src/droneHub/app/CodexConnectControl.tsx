    ...
    >
      <div className="flex flex-wrap items-center justify-between gap-2">
        <div>
          ...
          <div className="mt-0.5 text-10 text-[var(--muted)]">
            {finishing
        ...
        <div className="flex items-center gap-2">
          {!finishing && waiting && login?.authorizationUrl ? (
            <button
              ...
              className="h-8 rounded border border-[var(--border)] px-2.5 text-10 font-[var(--weight-semibold)] uppercase tracking-wide text-[var(--fg-secondary)] hover:bg-[var(--hover)]"
            >
              Reopen OpenAI
            </button>
          ) : null}
          {!finishing ? (
            <button
              ...
              className={`h-8 rounded border px-2.5 text-10 font-[var(--weight-semibold)] uppercase tracking-wide ${
                waiting
