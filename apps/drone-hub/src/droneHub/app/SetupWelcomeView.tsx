            ...
            <div className="grid grid-cols-1 xl:grid-cols-[minmax(0,1.2fr)_minmax(320px,.8fr)]">
              <div className="px-6 py-6 sm:px-8 sm:py-8 flex flex-col gap-5">
                <div className="flex flex-col gap-3">
                  <div className="inline-flex items-center gap-2 text-10 uppercase tracking-[0.16em] text-[var(--muted-dim)]" style={{ fontFamily: 'var(--display)' }}>
                  ...
                  <div className="max-w-[64ch] text-13 leading-relaxed text-[var(--muted)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-3">
                  <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-soft)] px-4 py-4">
                    <div className="text-10 uppercase tracking-[0.1em] text-[var(--muted-dim)] font-[var(--weight-semibold)]">Active profile</div>
                  ...
                  <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-soft)] px-4 py-4">
                    <div className="text-10 uppercase tracking-[0.1em] text-[var(--muted-dim)] font-[var(--weight-semibold)]">Blockers</div>
                    <div className="mt-2 text-[22px] font-[var(--weight-semibold)] text-[var(--fg-strong)]" style={{ fontFamily: 'var(--display)' }}>
                      {blockers.length}
                    </div>
                    <div className="mt-1 text-11 text-[var(--muted-dim)]">Things that will stop important flows from working.</div>
                  </div>
                  <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-soft)] px-4 py-4">
                    <div className="text-10 uppercase tracking-[0.1em] text-[var(--muted-dim)] font-[var(--weight-semibold)]">Warnings</div>
                    <div className="mt-2 text-[22px] font-[var(--weight-semibold)] text-[var(--fg-strong)]" style={{ fontFamily: 'var(--display)' }}>
                      {recommended.length}
                    </div>
                    <div className="mt-1 text-11 text-[var(--muted-dim)]">Recommended improvements that are not hard blockers.</div>
                  </div>
                  <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-soft)] px-4 py-4">
                    <div className="text-10 uppercase tracking-[0.1em] text-[var(--muted-dim)] font-[var(--weight-semibold)]">Profile contents</div>
                    <div className="mt-2 text-[22px] font-[var(--weight-semibold)] text-[var(--fg-strong)]" style={{ fontFamily: 'var(--display)' }}>
                ...
                <div className="flex flex-wrap gap-2">
                  <button
                    ...
                    className={`h-10 px-4 rounded text-11 font-[var(--weight-semibold)] tracking-wide uppercase border transition-all ${
                  ...
                  <button
                    ...
                    className="h-10 px-4 rounded text-11 font-[var(--weight-semibold)] tracking-wide uppercase border transition-all bg-[var(--surface-softest)] border-[var(--border-subtle)] text-[var(--muted)] hover:bg-[var(--hover)] hover:text-[var(--fg-secondary)]"
                    style={{ fontFamily: 'var(--display)' }}
                  >
                    Open profiles
                  </button>
              ...
              <div className="border-t xl:border-t-0 xl:border-l border-[var(--border)] bg-[var(--panel-alt)] px-6 py-6 sm:px-8 sm:py-8 flex flex-col gap-4">
                <div>
                  <div className="text-10 uppercase tracking-[0.12em] text-[var(--muted-dim)] font-[var(--weight-semibold)]" style={{ fontFamily: 'var(--display)' }}>
                    Suggested flow
                  </div>
                  <div className="mt-2 text-12 leading-relaxed text-[var(--muted)]">
                ...
                <div className="flex flex-col gap-3">
                  <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-inset)] px-4 py-4">
                    <div className="text-11 font-[var(--weight-semibold)] text-[var(--fg-secondary)]">1. Resolve blockers</div>
                    <div className="mt-1 text-11 text-[var(--muted-dim)]">Docker, GitHub auth, and LLM setup have the biggest impact on first-run success.</div>
                  </div>
                  <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-inset)] px-4 py-4">
                    <div className="text-11 font-[var(--weight-semibold)] text-[var(--fg-secondary)]">2. Choose your profile strategy</div>
                    <div className="mt-1 text-11 text-[var(--muted-dim)]">Keep this profile empty for onboarding tests or start creating drones and repos here.</div>
                  </div>
                  <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-inset)] px-4 py-4">
                    <div className="text-11 font-[var(--weight-semibold)] text-[var(--fg-secondary)]">3. Optional base image</div>
                    <div className="mt-1 text-11 text-[var(--muted-dim)]">Nice to have, not required. It improves repeatability once you know the shape of your environment.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.35fr)_minmax(320px,.65fr)] gap-4">
            <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--panel-alt)] px-5 py-5">
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <div className="mt-1 text-12 text-[var(--muted)]">Backend-reported readiness for the current machine and active profile.</div>
                </div>
              </div>
              ...
              <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3">
                {(setupStatusLoading && !setupStatus
                  ? Array.from({ length: 4 }).map((_, index) => (
                      <div key={index} className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-soft)] px-4 py-4 text-12 text-[var(--muted-dim)]">
                        Loading checks…
                      </div>
                    ))
                  : dependencies
                  ...
                  item?.id ? (
                    <div key={item.id} className={`rounded-2xl border px-4 py-4 ${dependencyTone(item.status, Boolean(item.blocking))}`}>
                      <div className="flex items-center justify-between gap-3">
                        <div className="text-13 font-[var(--weight-semibold)] text-[var(--fg-secondary)]">{item.label}</div>
                        <div className="text-10 uppercase tracking-[0.12em] text-[var(--muted-dim)]">
                          {dependencySeverityLabel(item.status, Boolean(item.blocking))}
                        </div>
                      </div>
                      <div className="mt-2 text-11 text-[var(--muted-dim)]">Used for {item.requiredFor}</div>
                      <div className="mt-3 text-12 leading-relaxed text-[var(--fg-secondary)]">{item.detail}</div>
                    </div>
                  ) : (
                    <div key={index} />
                  ),
            ...
            <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--panel-alt)] px-5 py-5 flex flex-col gap-4">
              <div>
                ...
                <div className="mt-2 text-12 text-[var(--muted)]">
              ...
              <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-softest)] px-4 py-4">
                <div className="text-11 font-[var(--weight-semibold)] text-[var(--fg-secondary)]">Drone data root</div>
                <div className="mt-2 text-11 text-[var(--muted-dim)] break-all">{setupStatus?.profile.droneDataDir ?? 'Loading…'}</div>
              </div>
              <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-softest)] px-4 py-4">
                <div className="text-11 font-[var(--weight-semibold)] text-[var(--fg-secondary)]">DVM data root</div>
                <div className="mt-2 text-11 text-[var(--muted-dim)] break-all">{setupStatus?.profile.dvmDataDir ?? 'Loading…'}</div>
              </div>
              <div className="rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-softest)] px-4 py-4">
                <div className="text-11 font-[var(--weight-semibold)] text-[var(--fg-secondary)]">Recommended next move</div>
