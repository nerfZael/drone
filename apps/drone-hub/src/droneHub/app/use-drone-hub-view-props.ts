...
export function useDroneHubWorkspaceContentProps(args: any): DroneHubWorkspaceContentProps {
  ...
  return {
    ...
    settingsViewProps: {
      ...
      agentMessageAutoContinue: agentMessageAutoContinueSettingsState,
      agentSuggestion: agentSuggestionSettingsState,
      ...
      desktopVoiceModel: desktopVoiceModelSettingsState,
      voiceApproval: voiceApprovalSettingsState,
      syncSets: syncSetsState,
