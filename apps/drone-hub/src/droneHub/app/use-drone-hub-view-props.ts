...
export function useDroneHubOverlaysProps(args: any): DroneHubOverlaysProps {
  ...
  return {
    createDronesModalProps: {
      ...
      agentsMdLibraryError,
      createAgentsMdLibraryFileId,
      onCreateAgentsMdLibraryFileIdChange: setCreateAgentsMdLibraryFileId,
      createAgentsMdOverrideEnabled,
      onCreateAgentsMdOverrideEnabledChange: setCreateAgentsMdOverrideEnabled,
      createAgentsMdOverride,
      onCreateAgentsMdOverrideChange: setCreateAgentsMdOverride,
      createRepoMenuEntries,
      createRepoMenuOpen,
