...
export function CustomAgentsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[var(--scrim-soft)] backdrop-blur-sm px-4" role="dialog" aria-modal="true">
      <div className="w-full max-w-[640px] rounded-[var(--radius-large)] border border-[var(--border-subtle)] bg-[var(--panel-alt)] shadow-[0_24px_80px_var(--shadow-color)] overflow-hidden animate-slide-up relative">
        <div className="px-5 py-4 border-b border-[var(--border)] flex items-center justify-between gap-3">
          <div className="font-[var(--weight-semibold)] text-sm text-[var(--fg-strong)] tracking-wide uppercase" style={{ fontFamily: 'var(--display)' }}>Custom agents</div>
          <button
            type="button"
        ...
        <div className="px-5 py-4">
          {customAgentError && (
            <div className="mb-3 p-3 rounded-[var(--radius-large)] bg-[var(--red-subtle)] border border-[var(--red-border)] text-xs text-[var(--red)]">
              {customAgentError}
            </div>
          )}
                ...
                {customAgents.map((a) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center w-7 h-7 rounded-[var(--radius-medium)] border bg-[var(--panel-raised)] border-[var(--border-subtle)] text-[var(--muted)] hover:text-[var(--red)] hover:border-[var(--red-border)] hover:bg-[var(--red-subtle)] transition-colors"
