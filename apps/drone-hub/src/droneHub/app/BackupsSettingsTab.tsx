...
function ToggleButton({
  ...
  return (
    ...
    >
      <span className={`h-3.5 w-6 rounded-full ${active ? 'bg-[rgba(0,0,0,.22)]' : 'bg-[rgba(148,163,184,.24)]'}`}>
        <span
  ...
  return (
    <div
      className={`grid grid-cols-1 gap-2 rounded border px-3 py-3 text-[11px] md:grid-cols-[110px_130px_minmax(0,1fr)_110px] ${
        manifest.suspect
          ? 'border-[rgba(251,191,36,.32)] bg-[rgba(251,191,36,.07)]'
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="rounded border border-[var(--border-subtle)] bg-[rgba(0,0,0,.12)] px-3 py-3">
        ...
        {backupSettingsNotice && (
          <div className="mt-3 rounded border border-[rgba(52,211,153,.2)] bg-[rgba(16,185,129,.08)] px-3 py-2 text-[12px] text-[#34d399]">
            {backupSettingsNotice}
          </div>
        )}
          ...
          <div className="grid grid-cols-2 gap-2">
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                disabled={disabled}
                inputMode="numeric"
                className="h-9 rounded border border-[var(--border-subtle)] bg-[rgba(0,0,0,.15)] px-2 text-[12px] text-[var(--fg)] focus:border-[var(--accent-muted)] focus:outline-none"
              />
            </label>
            <label className="flex flex-col gap-1">
      ...
      <div className="rounded border border-[var(--border-subtle)] bg-[rgba(0,0,0,.12)] px-3 py-3">
        ...
        <div className="mt-3 flex flex-col gap-2">
          {backupSettings?.recent.length ? (
            ...
            <div className="rounded border border-[var(--border-subtle)] bg-[rgba(255,255,255,.02)] px-3 py-3 text-[12px] text-[var(--muted)]">
