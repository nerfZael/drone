...
export function GroupMultiChatColumn({
  ...
  return (
    ...
    >
      ...
      <div hidden={compact} className={compact ? 'hidden' : 'group/column-header flex-shrink-0 px-3 py-2.5 border-b border-[var(--border-subtle)] bg-[var(--surface-softest)]'}>
        <div className="min-w-0">
          ...
          <div className="flex items-center gap-1.5 text-10 text-[var(--muted-dim)] font-mono mt-0.5">
            <span className="min-w-0 truncate">chat: {chatName}</span>
            <ChatUsageBadge droneId={drone.id} chatName={chatName} />
          </div>
