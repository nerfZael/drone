...
export function StatusBadge({
  ...
  if (hubPhase === 'draft') {
    return (
      <span
        className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-10 font-[var(--weight-semibold)] tracking-wide uppercase bg-[var(--user-subtle)] text-[var(--muted)] border border-[var(--user-border)]"
  ...
  if (hubPhase === 'error') {
    ...
    return (
      <span
        className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-10 font-[var(--weight-semibold)] tracking-wide uppercase bg-[var(--red-subtle)] text-[var(--red)] border border-[var(--red-border)]"
        style={{ fontFamily: 'var(--display)' }}
        title={title}
        aria-label="Error"
      >
  ...
  if (checking) {
    return (
      <span
        className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-10 font-[var(--weight-semibold)] tracking-wide uppercase bg-[var(--yellow-subtle)] text-[var(--yellow)] border border-[var(--yellow-border)]"
        style={{ fontFamily: 'var(--display)' }}
