  ...
  const content = (
    <>
      ...
      {at ? (
        <RelativeTimeText
          at={at}
          className="ml-auto text-caption leading-none tabular-nums text-[var(--chat-message-time)] opacity-0 transition-opacity group-hover/turn:opacity-100 group-focus-within/turn:opacity-100"
