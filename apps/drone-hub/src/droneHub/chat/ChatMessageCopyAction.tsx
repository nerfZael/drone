    ...
    >
      {copied ? (
        <div
          role="status"
          aria-live="polite"
          className={`pointer-events-none absolute whitespace-nowrap rounded border border-[var(--user-border)] bg-[var(--scrim-soft)] px-2 py-1 text-9 uppercase tracking-wide text-[var(--fg-secondary)] ${
