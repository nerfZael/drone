        ...
        if (control.kind === 'text') {
          return (
            <input
              ...
              className={`h-8 rounded-[var(--chat-composer-control-radius)] border border-[var(--chat-composer-control-border)] bg-[var(--chat-composer-control-bg)] px-2 text-compact font-medium text-[var(--chat-composer-control-fg)] placeholder:text-[var(--chat-composer-placeholder)] focus:outline-none ${controlWidthClass(control.width)} ${
                control.disabled
            ...
            >
              {control.options.map((option) => (
                <button
                  ...
                  title={option.title}
                  className={`min-w-[2.625rem] px-2 text-caption font-medium disabled:opacity-40 ${
