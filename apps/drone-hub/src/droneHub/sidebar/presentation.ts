...
const SIDEBAR_DENSITY_CLASSES: Record<SidebarDensityMode, SidebarDensityClasses> = {
  compact: {
    ...
    chatRow: 'h-6 pl-1 pr-1.5 text-sidebar-item-compact',
    ...
    folderLabel: 'text-sidebar-item-compact',
    folderInput: 'text-sidebar-item-compact',
  ...
  default: {
    ...
    chatRow: 'h-[25px] pl-1 pr-1.5 text-sidebar-item',
    ...
    folderRow: 'min-h-7',
    folderPaddingX: 'px-1 py-0.5',
    folderLabel: 'text-sidebar-item',
    folderInput: 'text-sidebar-item',
  ...
  comfortable: {
    ...
    chatRow: 'h-7 pl-1 pr-2 text-sidebar-item-comfortable',
    ...
    folderLabel: 'text-sidebar-item-comfortable',
    folderInput: 'text-sidebar-item-comfortable',
...
export function sidebarChatRowTone(args: {
  ...
  if (args.selected) {
    return `dh-sidebar-row-interactive dh-sidebar-row-selected border-transparent text-[var(--sidebar-drone-selected-fg,var(--sidebar-drone-fg))] ${focusClass}`;
  }
  if (args.active) {
