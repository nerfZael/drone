    ...
    <div className="fixed bottom-3 left-3 right-3 z-[90] flex justify-center pointer-events-none md:bottom-4">
      ...
      >
        <div className="min-w-0">
          <div className="text-12 font-[var(--weight-semibold)] text-[var(--fg)]">New Drone Hub is ready</div>
          <div className="truncate text-11 text-[var(--muted)]">
            Refresh to load the latest frontend.
          </div>
        </div>
        <button
          type="button"
          className="shrink-0 rounded border border-[var(--accent-muted)] bg-[var(--accent)] px-3 py-1.5 text-12 font-[var(--weight-semibold)] text-[var(--accent-fg)] hover:brightness-110"
