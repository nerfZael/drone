...
const styles = StyleSheet.create({
  ...
  deviceOfflineRetryText: { color: colors.textSecondary, fontSize: 13, fontWeight: '600' },
  ...
  deviceOfflineAutomaticText: { color: colors.mutedDim, fontSize: 12 },
  ...
  offlineChatNoticeTitle: { color: colors.textSecondary, fontSize: 13, fontWeight: '600' },
  offlineChatNoticeBody: { color: colors.mutedDim, fontSize: 12, lineHeight: 17, marginTop: 1 },
  ...
  startupStatus: { color: colors.muted, paddingHorizontal: 16, paddingVertical: 8, fontSize: 13 },
