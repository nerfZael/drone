    ...
    <View style={styles.interruptedCard}>
      ...
      >
        <View style={styles.interruptedIcon}>
          <TriangleAlert color={colors.warning} size={15} strokeWidth={2.2} />
        </View>
...
function ToolStatus({
  ...
  return (
    ...
    >
      {blocked ? (
        <Pause color={colors.warning} size={13} strokeWidth={2.2} />
      ) : pending ? (
        ...
        >
          {failed ? (
            <X color={colors.onAccent} size={10} strokeWidth={2.5} />
          ) : partial ? (
            <TriangleAlert color={colors.onAccent} size={9} strokeWidth={2.2} />
          ) : (
            <Check color={colors.onAccent} size={10} strokeWidth={2.5} />
          )}
        </View>
      )}
    </View>
...
const styles = StyleSheet.create({
  ...
  changedFilesAdditions: { color: colors.online, fontSize: 11, fontVariant: ['tabular-nums'] },
  changedFilesModified: { color: colors.warning, fontSize: 11, fontVariant: ['tabular-nums'] },
  changedFilesDeletions: { color: colors.danger, fontSize: 11, fontVariant: ['tabular-nums'] },
  ...
  changedFilesPath: { flex: 1, color: colors.text, fontSize: 12, fontFamily: 'monospace' },
  ...
  changedFilesFileAdditions: { color: colors.online, fontSize: 11, fontVariant: ['tabular-nums'] },
  changedFilesFileDeletions: { color: colors.danger, fontSize: 11, fontVariant: ['tabular-nums'] },
  ...
  changedFilesDiffHint: { color: colors.muted, fontSize: 11, paddingHorizontal: 12, paddingTop: 6 },
  ...
  changedFilesDiffErrorText: { flex: 1, color: colors.danger, fontSize: 12, lineHeight: 17 },
  changedFilesDiffRetry: { color: colors.accent, fontSize: 12, fontWeight: '600' },
  messages: { gap: 0 },
  runBody: { marginHorizontal: 16 },
  runDetails: { paddingBottom: 6 },
  ...
  runSummaryLabel: { color: colors.muted, fontSize: 13, fontWeight: '600' },
  runSummaryLabelComfortable: { fontSize: 14 },
  ...
  runTimingDetailComfortable: { fontSize: 13 },
  plan: {
    minWidth: 0,
    paddingVertical: 3,
  },
  planToggle: { flexDirection: 'row', alignItems: 'center', gap: 6, minHeight: 28 },
  planTogglePressed: { opacity: 0.68 },
  planToggleText: { color: colors.muted, fontSize: 13, fontWeight: '600' },
  planToggleTextComfortable: { fontSize: 14 },
  planProgress: {
    color: colors.mutedDim,
    fontSize: 12,
    fontVariant: ['tabular-nums'],
  },
  planProgressComfortable: { fontSize: 13 },
  planItems: { gap: 8, marginTop: 6 },
  ...
  planItemText: { flex: 1, color: colors.textSecondary, fontSize: 13, lineHeight: 19 },
  planItemTextComfortable: { fontSize: 14, lineHeight: 21 },
  planItemDone: {
    color: colors.mutedDim,
  ...
  planMore: { color: colors.accent, fontSize: 12, fontWeight: '600', marginTop: 2 },
  message: { width: '100%', paddingHorizontal: 16, paddingVertical: 12 },
  userMessageGroup: {
    width: 'auto',
    maxWidth: '84%',
    alignSelf: 'flex-end',
  ...
  messageError: { color: colors.danger, fontSize: 13, lineHeight: 19, marginTop: 6 },
  interruptedCard: {
    marginHorizontal: 16,
    marginVertical: 6,
    borderWidth: 1,
  ...
  images: { gap: 8, marginTop: 10 },
  image: { width: '100%', height: 220, borderRadius: 14, backgroundColor: colors.panel },
  attachments: { gap: 8, marginTop: 10 },
  fullMessageButton: {
    minHeight: 28,
    alignSelf: 'flex-start',
    alignItems: 'center',
  ...
  attachmentName: { color: colors.text, fontSize: 13, fontWeight: '600' },
  attachmentMeta: { color: colors.muted, fontSize: 11, marginTop: 2 },
  tool: {
    marginHorizontal: 0,
    marginVertical: 1,
  },
  ...
  toolDetailsNested: { marginLeft: 24, borderLeftWidth: 0, paddingLeft: 0 },
  ...
  detailText: { color: colors.muted, fontSize: 12, lineHeight: 17, fontFamily: 'monospace' },
  detailPlaceholder: {
    color: colors.mutedDim,
    fontSize: 12,
    lineHeight: 17,
  ...
  detailList: { gap: 7 },
  detailField: { gap: 2 },
  detailFieldLabel: { color: colors.mutedDim, fontSize: 11, fontWeight: '600' },
  ...
  toolSummary: { color: colors.muted, fontSize: 11, lineHeight: 15, marginTop: 3 },
  transferBytes: { color: colors.muted, fontSize: 11, fontVariant: ['tabular-nums'] },
  progressTrack: {
    height: 5,
    borderRadius: 3,
    overflow: 'hidden',
  ...
  transferMetaText: { color: colors.subtle, fontSize: 11, fontVariant: ['tabular-nums'] },
  transferFiles: {
    gap: 10,
    marginLeft: 7,
    borderLeftWidth: 1,
  ...
  transferFilesNested: { marginLeft: 24, borderLeftWidth: 0, paddingLeft: 0 },
  transferFile: {
    paddingVertical: 2,
  },
  transferFileHead: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  transferFileName: { color: colors.text, fontSize: 12, flex: 1, minWidth: 0 },
  transferFileBytes: { color: colors.subtle, fontSize: 11, fontVariant: ['tabular-nums'] },
  ...
  transferError: { color: colors.danger, fontSize: 11, lineHeight: 15, marginTop: 5 },
  thinkingActivity: {
    minHeight: 32,
    flexDirection: 'row',
    alignItems: 'center',
  ...
  thinkingActivityText: { color: colors.muted, fontSize: 13, fontWeight: '500' },
  reasoning: {
    marginHorizontal: 16,
    marginVertical: 10,
    padding: 14,
  ...
  waiting: { alignSelf: 'stretch', gap: 8, marginHorizontal: 16, marginVertical: 8 },
  reasoningHead: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  reasoningLabel: { color: colors.muted, fontSize: 12, fontWeight: '600' },
  reasoningText: { color: colors.muted, fontSize: 13, lineHeight: 19, marginTop: 10 },
