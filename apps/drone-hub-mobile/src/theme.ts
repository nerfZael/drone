...
export const colors = {
  ...
  sidebarFg: catppuccin.subtext0,
  sidebarFgActive: catppuccin.subtext1,
  sidebarHeadingFg: catppuccin.subtext1,
  sidebarActionFg: catppuccin.overlay1,
  sidebarMetaFg: catppuccin.overlay1,
  sidebarSubitemFg: catppuccin.overlay1,
