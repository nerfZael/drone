...
export const colors = {
  ...
  sidebarSelectionWash: 'rgba(203, 166, 247, 0.12)',
  sidebarSelectionEdge: 'rgba(203, 166, 247, 0.78)',
  sidebarBlockedIndicator: '#ff596b',
  sidebarFg: catppuccin.text,
  sidebarFgActive: '#f2f4ff',
  sidebarHeadingFg: catppuccin.text,
  sidebarActionFg: catppuccin.subtext1,
  sidebarMetaFg: catppuccin.subtext0,
  sidebarSubitemFg: catppuccin.subtext1,
  sidebarMutedDim: catppuccin.subtext0,
  sidebarDroneFg: catppuccin.text,
  sidebarDroneActiveFg: '#f2f4ff',
  ...
  assistantText: catppuccin.text,
  chatListMarker: catppuccin.subtext0,
  chatCard: '#242437',
  chatCardSelected: catppuccin.surface0,
  ...
  whiteWash: 'rgba(205, 214, 244, 0.05)',
  whiteWashSoft: 'rgba(205, 214, 244, 0.03)',
} as const;
