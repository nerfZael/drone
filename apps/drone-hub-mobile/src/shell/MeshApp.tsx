...
const styles = StyleSheet.create({
  ...
  menuButtonActive: { backgroundColor: colors.accentDark },
  contextBackButton: {
    width: 28,
    borderWidth: 0,
    backgroundColor: 'transparent',
  ...
  actionMenuItemText: { color: colors.text, fontSize: 14, fontWeight: '500' },
