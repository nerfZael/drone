...
const styles = StyleSheet.create({
  ...
  createNowText: { color: colors.onAccent, fontSize: 12, fontWeight: '700' },
  ...
  pendingPrompt: { color: colors.userBubbleText, fontSize: 15, lineHeight: 22 },
  pendingImageCount: { color: colors.secondary, fontSize: 11, fontWeight: '600', marginTop: 4 },
  stoppedNotice: {
    maxWidth: '84%',
    minHeight: 52,
    flexDirection: 'row',
