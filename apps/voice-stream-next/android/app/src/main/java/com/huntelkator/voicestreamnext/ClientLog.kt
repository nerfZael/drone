...
object ClientLog {
    private const val LOG_TAG = "VoiceStreamNext"
    private const val MAX_LOG_BYTES = 512 * 1024
    private const val LOG_FILE = "voice-stream-next-debug.log"
    ...
    fun path(context: Context): String = file(context.applicationContext).absolutePath
