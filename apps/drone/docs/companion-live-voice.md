...
This integration uses the desktop/browser WebRTC path. Mobile Companion retains its record-and-transcribe voice input; its shared backend respects the same ASAP/Queue setting.
