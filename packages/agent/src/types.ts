...
export interface AgentLoopConfig extends SimpleStreamOptions {
   ...
   * Return `{ suspend: ... }` to stop before execution without emitting a tool result, so a host
   * can durably resolve the call and continue it later.
...
/** A deliberate preflight decision to defer a tool call before it executes. */
